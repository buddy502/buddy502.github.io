...
/*
   Grab all the songs ahead of time so that a queue is possible
   */
...
function queueFullPlaylist() {
   // Save the song that was already the head
   const firstSong = dll.head;

   const request = indexedDB.open("FileDatabase");
   ...
   request.onsuccess = function () {
      ...
      countRequest.onsuccess = function () {
         const totalSongs = countRequest.result;
